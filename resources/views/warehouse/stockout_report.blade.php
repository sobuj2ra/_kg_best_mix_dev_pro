                        ...
                        <div class="col-md-5">
                            <div style="margin: 10px; border: 2px solid #dddddd52; border-radius: 5px">
                                <div style="border-top: 5px solid #bd4747; padding: 5px; margin: 5px;">
                                    ...
                                    <hr>
                                    <form action="{{ URL::to('/stockout-report') }}" method="post">
                                        {{ csrf_field() }}
                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="printableArea">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <br>
                                            <h4 style="text-align:center"><b>Stock Out Details</b></h4>
                                        </div>
                                    <table width="100%" id="showproduct" class="table-bordered table"
                                        ...
                                        <tbody>
                                        @php $n=0; @endphp
                                        @foreach($todayStockOuts as $todayStockOut)
                                            @php $n++; @endphp
                                            <tr>
                                                <td scope="col">{{$n}}</td>
                                                <td scope="col">
                                                        <button class="btn btn-flat btn-warning btn-xs" style="font-size: 17px">{{@$todayStockOut->product_name}}</button>

                                                </td>
                                                <td scope="col">{{$todayStockOut->total_product_qty}}</td>
                                                <td scope="col">{{$todayStockOut->total_product_weight}}</td>
                                                <td scope="col">{{$todayStockOut->created_at}}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
