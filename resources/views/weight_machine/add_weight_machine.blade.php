                                    ...
                                    <div class="change_passport_body" style="width: 100% !important;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-md-offset-3" >
                                                <form action="{{URL::to('weightmachine/add')}}" method="POST">
                                                    {{csrf_field()}}
                                                    <div class="form-group">
                                                        <label for="add_weight_machine_name">Add Weight Machine Name</label>
                                                        <input name="weight_machine_name" type="text" id="weight_machine_name" class="form-control" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="add_weight_machine_host">Add Weight Machine Host</label>
                                                        <input name="weight_machine_host" type="text" id="weight_machine_name" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="add_weight_machine_port">Add Weight Machine Port</label>
                                                        <input name="weight_machine_port" type="number" id="weight_machine_name" class="form-control">
                                                    </div>
                                                    <div class="form-group">
